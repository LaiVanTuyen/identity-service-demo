...
import com.vti.tuyn.identityservicedemo.exception.AppException;
import com.vti.tuyn.identityservicedemo.exception.ErrorCode;
import com.vti.tuyn.identityservicedemo.repository.InvalidatedTokenRepository;
...
import com.vti.tuyn.identityservicedemo.service.IAuthenticationService;
...
public class AuthenticationServiceImpl implements IAuthenticationService {
    ...
    private String generateToken(User user) {
        ...
        JWTClaimsSet jwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .issuer("devteria.com") // domain of service
                .issueTime(new Date())
